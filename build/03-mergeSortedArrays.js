#!/usr/bin/node
"use strict";
var MergeSortedArraysNameSpace;
(function (MergeSortedArraysNameSpace) {
    ...
    function mergeSortedArrrays(arr1, arr2) {
        if (arr1.length === 0)
            return arr2;
        if (arr2.length === 0)
            return arr1;
    ...
    function mergeSortedArrrays2(arr1, arr2) {
        if (arr1.length === 0)
            return arr2;
        if (arr2.length === 0)
            return arr1;
...
})(MergeSortedArraysNameSpace || (MergeSortedArraysNameSpace = {}));
